...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.pinterest = !isEmpty(profile.social.pinterest) ? profile.social.pinterest : '';
      profile.personal = !isEmpty(profile.social.personal) ? profile.social.personal : '';
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              <Link to="/dashboard" className="btn btn-light pl-4 pr-4">
                Go Back
              </Link>
